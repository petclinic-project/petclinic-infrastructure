# 1. IAM Role for EKS Auto Mode
resource "aws_iam_role" "eks_cluster" {
  name = "${var.project}-eks-role-${var.environment}"
...
# Auto Mode requires these 5 specific managed policies
...
# 2. The EKS Cluster (Auto Mode Enabled)
